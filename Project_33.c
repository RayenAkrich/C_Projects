//Le but de ce programme est de remplir une liste doublement chainée en date et température ,supprime de cases selon le choix de la temperature par l'utilisateur
//ou bien ajouter une case apres une temperature donné par l'utilisateur
